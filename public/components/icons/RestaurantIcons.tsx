...
export const AddMenuVector: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="200" height="120" rx="16" fill="#84D14D" />
        <path d="M60 80C60 80 50 100 80 100H120C150 100 140 80 140 80H60Z" fill="#EAEAEA" />
        <path d="M60 40H140V80H60V40Z" fill="#F4F4F4" />
        <circle cx="80" cy="50" r="5" fill="#FFB74D" />
        <circle cx="100" cy="60" r="5" fill="#4CAF50" />
        <circle cx="120" cy="45" r="5" fill="#F44336" />
        <path d="M50 40H150" stroke="white" strokeWidth="4" strokeLinecap="round" />
    </svg>
);
